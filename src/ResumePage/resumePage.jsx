...
import Resume_ from '../assets/pdf/Resume_.pdf';
                ...
                <div className="cv">
                    <div className="template" style={{ height: '1000px', backgroundColor: '#1A1821' , width: '660px'}}>
                        <Worker workerUrl={`https://unpkg.com/pdfjs-dist@3.11.174/build/pdf.worker.min.js`}>
                            <Viewer fileUrl={Resume_} />
                        </Worker>
                    </div>
                </div>
                <a href={Resume_} download={"Kunal_Mittal_Resume.pdf"} className="text-white flex items-center gap-1">
