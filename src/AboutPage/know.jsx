import knowImg from '../assets/images/know-img.png';
const Know = ()=>{
    return (
        <div className="know mt-36 flex flex-col gap-16 items-center md:flex-row md:justify-center md:items-center md:gap-0">
            <div className="know-content w-4/5 md:w-1/2">
                <p className="text-3xl text-white font-semibold mb-10">Know Who <span className="km">I'M</span></p>
                <div className="text-2xl know-content-wrap text-white text-left flex flex-col gap-4">
                    <p>Hi Everyone, I am <span className="km">Kunal Mittal</span> from <span className="km">Uttar Pradesh,India.</span></p> 
                    <p>I have recently graduated from <span className="km">KIET Group Of Instititions</span> with a degree in Electronics and Communications & Engineering.</p>
                    <p>I am currently working as a intern at Geekster.</p>
                </div>
                <div className="extra-act text-xl mt-10 text-left text-white">
                    <p className="mb-4">Apart from coding, some other activities that I love to do!</p>
                    <div className="act">
                        <div className="quote flex items-center gap-2 ml-10">
                        ...
                        <blockquote className='mt-8 text-center'>
                            <cite>"Strive to build things that make a difference!"</cite>
                            <p>-Kunal</p>
                        </blockquote>
                    </div>
                </div>               
            </div>
            <div className="know-img w-1/2 md:w-1/4">
                <img className="w-full" src={knowImg} alt="" />
            </div>
        </div>
    )
}
